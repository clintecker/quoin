...
version here. See `docs/history/math-extraction.md` for the extraction history.
...
- **Verification harnesses**: compositor-truth flip fidelity; per-feature
  latency budgets (see `docs/history/launch-ledger.md` for the enrollment gaps).
...
- **Ledgers**: `docs/history/rendering-ledger.md` (field reports → fixes),
  `docs/history/launch-ledger.md` (four-track pre-launch review).
