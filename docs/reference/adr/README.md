...
| [0003](0003-first-party-engines.md) | Math and diagrams are **first-party packages** ([Vinculum](https://github.com/clintecker/Vinculum), [MermaidKit](https://github.com/clintecker/MermaidKit)) consumed from GitHub | The engines are products in their own right; splitting them out keeps their large test suites off Quoin's CI and lets other hosts adopt them. |
