...
drifts; see [adr/0003](adr/0003-first-party-engines.md)).
...
[architecture.md](architecture.md) for where it sits in the pipeline.
...
> [adr/0003](adr/0003-first-party-engines.md) and mirrored for MermaidKit in
